        ...
        <div class="col-md-9 col-sm-12 mt-2">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form action="{{ route('workshop.store') }}" method="post" enctype="multipart/form-data" style="width: 100%;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="price" class="form-control" id="price" placeholder="Workshop Price">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="file" name="thumbnail" class="form-control-file check-image-size" id="thumbnail" data-min-width="400" data-min-height="300" data-max-width="400" data-max-height="300" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="duration" class="form-control" id="duration" placeholder="Workshop duration">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="courseName" class="col-sm-2 col-form-label">Total Credit Hours:</label>
                            <div class="col-sm-10">
                                <input type="text" name="total_credit_hours" class="form-control" id="duration" placeholder="Total Credit Hours">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="courseName" class="col-sm-2 col-form-label">Date & Time:</label>
                            <div class="col-sm-10">
                                <input type="text" name="date_time" class="form-control" id="date_time" placeholder="Date & Time">
                            </div>
                        </div>
                        <div class="form-group row">
