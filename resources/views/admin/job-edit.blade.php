                        ...
                        <div class="col-sm-12 mb-5">
                            ...
                            <form action="{{ route('admin.job.update', $job->id) }}" method="post" enctype="multipart/form-data" style="width: 100%;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <p style="margin: 6px 0 0"> {!! nl2br(e($job->description)) !!}</p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Job Responsibilities:</label>
                                    <div class="col-sm-10">
                                        <p style="margin: 6px 0 0">{!! nl2br(e($job->job_responsibilities)) !!}</p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Educational Requirements:</label>
                                    <div class="col-sm-10">
                                        <p style="margin: 6px 0 0">{!! nl2br(e($job->educational_requirements)) !!}</p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Experience Requirements:</label>
                                    <div class="col-sm-10">
                                        <p style="margin: 6px 0 0">{!! nl2br(e($job->experience_requirements)) !!}</p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Additional Requirements:</label>
                                    <div class="col-sm-10">
                                        <p style="margin: 6px 0 0">{!! nl2br(e($job->additional_requirements)) !!}</p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Compensation & Other Benefits:</label>
                                    <div class="col-sm-10">
                                        <p style="margin: 6px 0 0">{!! nl2br(e($job->compensation_other_benefits)) !!}</p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Gender Preference:</label>
                                    <div class="col-sm-10">
                                        <p style="margin: 6px 0 0">{{$job->gender}}</p>
                                    </div>
                                </div>
                                <div class="form-group row">
